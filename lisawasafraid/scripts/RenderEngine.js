RenderEngineClass = Class.extend(
{
	...
	render: function()
	{
		...
		{ 
			if(this.storyOpacity > 0.01) { var o = this.storyOpacity - (this.render_unit/50000); this.storyOpacity = o > 0.01 ? o : 0.01; }
		}
		else if(gEngine.gameOver)
		{
			if(this.storyOpacity > 0.01) { var o = this.storyOpacity - (this.render_unit/6000); this.storyOpacity = o > 0.01 ? o : 0.01; }
		}
		else
		{
